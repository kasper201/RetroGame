...
#
# Script generated by Vivado on Fri Apr 12 21:12:14 +0200 2024
...
#
# Usage        : blk_mem_gen_3.sh
#                blk_mem_gen_3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_mem_gen_3.sh [-reset_run]
#                blk_mem_gen_3.sh [-reset_log]
#                blk_mem_gen_3.sh [-help]
#
...
#                script (type 'blk_mem_gen_3.sh -help' for more information).
#
...
# script info
echo -e "blk_mem_gen_3.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_mem_gen_3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.blk_mem_gen_3 xil_defaultlib.glbl -o blk_mem_gen_3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./blk_mem_gen_3_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key blk_mem_gen_3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc blk_mem_gen_3_simv.daidir vcs_lib c.obj)
...
Usage: blk_mem_gen_3.sh [-step]\n\
Usage: blk_mem_gen_3.sh [-lib_map_path]\n\
Usage: blk_mem_gen_3.sh [-reset_run]\n\
Usage: blk_mem_gen_3.sh [-reset_log]\n\
Usage: blk_mem_gen_3.sh [-keep_index]\n\
