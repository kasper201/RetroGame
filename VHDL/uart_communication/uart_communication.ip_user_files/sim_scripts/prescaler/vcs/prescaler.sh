...
#
# Script generated by Vivado on Wed Apr 10 14:17:03 +0200 2024
...
#
# Usage        : prescaler.sh
#                prescaler.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                prescaler.sh [-reset_run]
#                prescaler.sh [-reset_log]
#                prescaler.sh [-help]
#
...
#                script (type 'prescaler.sh -help' for more information).
#
...
# script info
echo -e "prescaler.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./prescaler.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.prescaler xil_defaultlib.glbl -o prescaler_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./prescaler_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key prescaler_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc prescaler_simv.daidir vcs_lib c.obj)
...
Usage: prescaler.sh [-step]\n\
Usage: prescaler.sh [-lib_map_path]\n\
Usage: prescaler.sh [-reset_run]\n\
Usage: prescaler.sh [-reset_log]\n\
Usage: prescaler.sh [-keep_index]\n\
