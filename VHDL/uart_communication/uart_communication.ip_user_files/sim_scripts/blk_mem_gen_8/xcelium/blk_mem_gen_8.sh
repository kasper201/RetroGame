...
#
# Script generated by Vivado on Wed Apr 10 14:10:58 +0200 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : blk_mem_gen_8.sh
...
#
# Usage        : blk_mem_gen_8.sh
#                blk_mem_gen_8.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_mem_gen_8.sh [-reset_run]
#                blk_mem_gen_8.sh [-reset_log]
#                blk_mem_gen_8.sh [-help]
#
...
#                script (type 'blk_mem_gen_8.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname unisims_ver -libname unimacro_ver -libname secureip"
...
# script info
echo -e "blk_mem_gen_8.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_mem_gen_8.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.blk_mem_gen_8 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.blk_mem_gen_8 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/woute/Desktop/rest/HBO/Projecten/Retrogame/RetroGame/VHDL/uart_communication/uart_communication.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log blk_mem_gen_8_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blk_mem_gen_8.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blk_mem_gen_8.sh [-help]\n\
Usage: blk_mem_gen_8.sh [-step]\n\
Usage: blk_mem_gen_8.sh [-lib_map_path]\n\
Usage: blk_mem_gen_8.sh [-reset_run]\n\
Usage: blk_mem_gen_8.sh [-reset_log]\n\
Usage: blk_mem_gen_8.sh [-keep_index]\n\
Usage: blk_mem_gen_8.sh [-noclean_files]\n\n\
