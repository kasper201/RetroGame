...
#
# Script generated by Vivado on Wed Dec 06 13:56:15 +0100 2023
...
#
# Usage        : clk60Hz.sh
#                clk60Hz.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk60Hz.sh [-reset_run]
#                clk60Hz.sh [-reset_log]
#                clk60Hz.sh [-help]
#
...
#                script (type 'clk60Hz.sh -help' for more information).
#
...
# script info
echo -e "clk60Hz.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk60Hz.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clk60Hz xil_defaultlib.glbl -o clk60Hz_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clk60Hz_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key clk60Hz_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clk60Hz_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk60Hz.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk60Hz.sh [-help]\n\
Usage: clk60Hz.sh [-step]\n\
Usage: clk60Hz.sh [-lib_map_path]\n\
Usage: clk60Hz.sh [-reset_run]\n\
Usage: clk60Hz.sh [-reset_log]\n\
Usage: clk60Hz.sh [-keep_index]\n\
Usage: clk60Hz.sh [-noclean_files]\n\n\
